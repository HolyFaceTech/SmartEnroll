            ...
            >
                ...
                <div className="d-flex gap-2">
                    ...
                    {selectedIds.length > 0 && (
                        <button
                            className="btn btn-retro px-4 py-2 d-flex align-items-center gap-2 fade-in bg-danger text-white border-dark"
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="py-3 border-dark">
                                                    {subject.strand && (
                                                        <span
                                                            className="badge rounded-0 border border-dark px-2 py-1"
                                                            style={{
                                                                backgroundColor:
                                                                    bColor.bg,
                                                                color: bColor.text,
