...
export default function SubjectModal({
    ...
    const handleFormSubmit = (e) => {
        ...
        const icon = type === "create" ? "bi-book-half" : "bi-pencil-square";

        const messageContent =
            type === "create" ? (
                "Are you sure you want to save this new subject?"
            ) : (
                <>
    ...
    const executeSubmit = async () => {
        ...
        try {
            if (type === "create") {
                ...
                Toast.fire({
                    icon: "success",
                    title: res.data.message || "Subject Created Successfully!",
                });
            } else {
                ...
                Toast.fire({
                    icon: "success",
                    title: res.data.message || "Subject Updated Successfully!",
                });
            }
