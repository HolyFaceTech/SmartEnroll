...
export default function SectionListModal({
    show,
    onClose,
    sectionName,
    gradeLevel,
    ...
    const groupedStudents = {
        Male: students.filter((s) => s.gender === "Male"),
        Female: students.filter((s) => s.gender === "Female"),
    };
                        ...
                        >
                            {students.length === 0 ? (
                                ...
                                <div className="mb-5">
                                    ...
                                    {renderTable(groupedStudents.Male, "MALE")}
                                    {renderTable(
